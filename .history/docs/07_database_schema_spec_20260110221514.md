# [설계] 테이블오더 시스템 데이터베이스 상세 명세서 (v3.5)

> - **문서 번호:** 07_database_schema_spec.md
> - **작성 일자:** 2026.01.10
> - **버전:** v3.5 (Clean Ver.)
> - **설계 원칙:**
>   1. **Keyword Safe:** SQL 예약어(Order, Table, User 등) 충돌 방지를 위해 리네이밍 적용.
>   2. **ERD Type Defined:** 강한/약한/연관 개체 명시.
...
### 3.1 ORDERS (주문 헤더)
> **ERD Type: [Weak Entity]** (Parent: TABLES)
...
> **ERD Type: [Associative Entity]** (TABLES <-> STAFF_CALL_ITEMS)
...
| **table_id** | BigInt | **FK** | 테이블 ID | TABLES 참조 |
